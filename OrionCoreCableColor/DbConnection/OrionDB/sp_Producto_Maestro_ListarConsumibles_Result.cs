...
namespace OrionCoreCableColor.DbConnection.OrionDB
{
    ...
    public partial class sp_Producto_Maestro_ListarConsumibles_Result
    {
        ...
        public Nullable<int> fiIdTipoDeProductoContable { get; set; }
        ...
        public Nullable<decimal> fnStockMinimo { get; set; }
        public Nullable<bool> fbProductoGenerico { get; set; }
        public Nullable<bool> fbProductoDeInstalacion { get; set; }
    }
}
