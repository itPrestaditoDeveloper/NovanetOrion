var toGeoJSON = (function () {
  ...
  function c(e) {
    for (var t = e.replace(d, "").split(v), r = [], n = 0; n < t.length; n++)
      r.push(f(t[n]));
    return r;
  }
  function g(e) {
    var t,
      ...
      l = i(e, "time");
    return (
      o && ((t = parseFloat(s(o))), isNaN(t) || r.push(t)),
      {
        coordinates: r,
        time: l ? s(l) : null,
        heartRate: a ? parseFloat(s(a)) : null,
      }
    );
  }
  function h() {
  ...
  return (
    "undefined" != typeof XMLSerializer
      ...
      : "object" != typeof exports ||
        ...
        process.browser ||
        (m = new (require("xmldom").XMLSerializer)()),
    {
      kml: function (n) {
        function o(e) {
          var t, r;
          return (
            ...
            8 === e.length &&
              ...
              (t = "#" + e.substr(6, 2) + e.substr(4, 2) + e.substr(2, 2))),
            [t, isNaN(r) ? void 0 : r]
          );
        }
        function l(e) {
            ...
            if ((n = t(e, S[o])))
              for (a = 0; a < n.length; a++)
                if (((r = n[a]), "Point" === S[o]))
                  h.push({
                    type: "Point",
                    coordinates: f(s(i(r, "coordinates"))),
                  });
                else if ("LineString" === S[o])
                  h.push({
                    type: "LineString",
                    coordinates: c(s(i(r, "coordinates"))),
                  });
                else if ("Polygon" === S[o]) {
                  var m = t(r, "LinearRing"),
                    y = [];
                  for (l = 0; l < m.length; l++)
                    y.push(c(s(i(m[l], "coordinates"))));
                  h.push({ type: "Polygon", coordinates: y });
                } else if ("Track" === S[o] || "gx:Track" === S[o]) {
                  var d = u(r);
                  h.push({ type: "LineString", coordinates: d.coords }),
                    d.times.length && p.push(d.times);
                }
        ...
        for (
          var m = h(),
            ...
            d = {},
            v = {},
            S = ["Polygon", "LineString", "Point", "Track", "gx:Track"],
            k = t(n, "Placemark"),
            T = t(n, "Style"),
            x = t(n, "StyleMap"),
            b = 0;
        ...
        for (var N = 0; N < x.length; N++) {
          ...
          for (var M = t(x[N], "Pair"), P = {}, F = 0; F < M.length; F++)
            P[s(i(M[F], "key"))] = s(i(M[F], "styleUrl"));
          v["#" + r(x[N], "id")] = P;
        }
            ...
            (function (e) {
              ...
              if ((u && (l.name = u), f)) {
                "#" !== f[0] && (f = "#" + f),
                  ...
                  y[f] && (l.styleHash = y[f]),
                  v[f] &&
                    ((l.styleMapHash = v[f]), (l.styleHash = y[v[f].normal]));
                var x = d[l.styleHash];
                x &&
                  (S || (S = i(x, "LineStyle")), k || (k = i(x, "PolyStyle")));
              }
              ...
              if ((p && (l.timestamp = s(i(p, "when"))), S)) {
                ...
                M && (l.stroke = M),
                  isNaN(P) || (l["stroke-opacity"] = P),
                  isNaN(F) || (l["stroke-width"] = F);
              }
              if (k) {
                var w = o(s(i(k, "color"))),
                  R = w[0],
                ...
                R && (l.fill = R),
                  ...
                  G &&
                    (l["fill-opacity"] =
                      "1" === G ? l["fill-opacity"] || 1 : 0),
                  A &&
                    (l["stroke-opacity"] =
                      "1" === A ? l["stroke-opacity"] || 1 : 0);
              }
              if (m) {
                var C = t(m, "Data"),
                  H = t(m, "SimpleData");
                for (n = 0; n < C.length; n++)
                  l[C[n].getAttribute("name")] = s(i(C[n], "value"));
                for (n = 0; n < H.length; n++)
                  l[H[n].getAttribute("name")] = s(H[n]);
              }
              T && (l.visibility = s(T)),
                a.coordTimes.length &&
                  (l.coordTimes =
                    1 === a.coordTimes.length ? a.coordTimes[0] : a.coordTimes);
              var D = {
                type: "Feature",
                geometry:
                  1 === a.geoms.length
                    ? a.geoms[0]
                    : { type: "GeometryCollection", geometries: a.geoms },
                properties: l,
              };
      ...
      gpx: function (e) {
        function n(e, r) {
          ...
          for (var l = 0; l < s; l++) {
            ...
            i.push(u.coordinates),
              u.time && o.push(u.time),
              u.heartRate && a.push(u.heartRate);
          }
          return { line: i, times: o, heartRates: a };
        }
        function i(e) {
          var n, i;
          (n = l(e, ["name", "cmt", "desc", "time", "keywords"])),
            (i = t(e, "link")),
            i.length && (n.links = []);
        ...
        for (o = 0; o < s.length; o++)
          (a = (function (e) {
            for (
              var r, o = t(e, "trkseg"), a = [], s = [], l = [], u = 0;
              u < o.length;
              u++
            )
              (r = n(o[u], "trkpt")) &&
                (r.line && a.push(r.line),
                r.times && r.times.length && s.push(r.times),
                r.heartRates && r.heartRates.length && l.push(r.heartRates));
            if (0 !== a.length) {
              var f = i(e);
              return (
                ...
                l.length && (f.heartRates = 1 === a.length ? l[0] : l),
                {
                  ...
                  properties: f,
                  geometry: {
                    type: 1 === a.length ? "LineString" : "MultiLineString",
                    coordinates: 1 === a.length ? a[0] : a,
                  },
                }
              );
            }
            ...
            (function (e) {
              ...
              return (
                u(t, l(e, ["sym", "type"])),
                {
                  type: "Feature",
                  properties: t,
                  geometry: { type: "Point", coordinates: g(e).coordinates },
                }
              );
            })(c[o])
          );
